...
//
//  Created by Thuc Nhi Le on 5/25/18.
...
class WrappingLine: NSObject {
    ...
    func fourthQuadrant(){
        ...
        for _ in 1...pieces/4 {
            ...
            drawStraightLine(x: (r+length/2)*x, y: y, z: (r+length/2)*z , trans: i*p/CGFloat(pieces))
            i = i-2
        }
    }
    ...
    func drawStraightLine(x:CGFloat,y:CGFloat,z:CGFloat,trans: CGFloat){
        let node = SCNNode()
